...
- `es.able`（2026-09-11 新增）可覆寫 P3 的 `he is able to`：目前只有 #35 設 `able:'he is unable to'`（James 要特別記這題，讓 result 能直接寫負面結果）；模板卡藍字不受影響
