...
| ③-3 外語必修（原#37；2026-09-21 練前 James 指出 impl「自信 → 好職涯＋幸福家庭」跳太快，改 language skills bring more foreign clients, a steady income and a warm and stable home；漫畫新增 `P9` 單題覆寫第 9 格；同日首次逐 slot 練，情緒讓步線負面版四題收完，18 格全打完、1 拼字＋14 文法；make … as、a steady income 漏 a） | ✔ | ✔ impl 客戶→收入→家＋topic whether 句／a new language／foreign languages open／studied … in school |
| ②-9 年齡限制（原#29；2026-09-22 首次逐 slot 練，情緒讓步線正面版第一題，18 格全打完、2 拼字＋14 文法；get＋married 錯三次、可數單數裸奔 couple／hard time／job、⑭ 語序） | ✔ | ✔ impl can protect young couples＋「唸完書」三格統一 school（#14 does／rec 同句同步）＋數字改 25／26 |
| ④-9 早婚愚蠢（原#14；2026-09-23 首次逐 slot 練，情緒讓步線正面版第二題，18 格全打完、4 拼字＋10 文法；⑭ 時態、at／through、on time vs more than timing） | ✔ | ✔ does 拿掉 at 26（題目沒問年齡，與 #29 分開背） |
...
> 2026-09-12 **10 條故事線定案**（取代四條線的細分，寫進 WE_背誦地圖.html 區塊①）：主論 P3 ①穩定收入線（學生版 #1/2/3/5/9/13/19/22/27：get high grades and find a good job and a steady income → leads to a better future and a warm and stable home；上班版 #4/18/24/31：earn a steady income for his family）②先立業線 #14/29 ③陪家人線 #6/7/8/11/12/23/26/30/33/36（spend more quality time with his family → keeps the whole family in harmony）④安心線 #17/28/32（enjoy peace of mind）⑤視野自信線 #15/34/37 ⑥見證線 #10/16/20/25（As James saw… → see how…）⑦反面線 #21/35（keeps surfing… → he is unable to）；讓步 P2 ⑧視野讓步 #1/2/13/21/22/27/28 ⑨情緒讓步（負面 #4/5/19/37 feel upset and anxious；正面 #14/23/29/31 feel less lonely → peace of mind）⑩錢與方便讓步（賺錢 #11/12/24/30/32；錢 #8/10/15；方便 #3/7/18/34/35/36）；問題面不讓步 #6/9/16/17/20/25/26/33。

> 2026-09-12 **統一用字盤查（A 級套用）**：James 要「不改邏輯語意、把片語覆蓋率從 16% 往上提」。工作流找出 42 組同義變體、每處過語意＋文法雙驗證，James 收 A 級 18 組共 63 處：收尾統一 keeps the whole family in harmony（#7/#8/#12/#18/#23/#26/#30/#32）、表態句統一 does more good than harm／does more harm than good／the good points … much greater than the bad points／bad points are greater than the good points（#4/#5/#6/#12/#18/#20/#21/#22/#23/#26/#27/#31/#33）、學業線 impl 統一 lead(s) to a better future and a warm and stable home（#2/#3/#9/#13/#19/#22/#27）、#14 P2/does/rec 對齊 #29、#1 P2 對齊 #2/#13/#22、#34/#37 result 同句、#4 resA anxious、#16 conR、#17 impl protect every family、#28/#30 enjoy peace of mind、#6/#21/#36 quality time。B 級（同題 vb＝stance＝final 三槽同句 C29/C30/C31/C40/C42）與 C 級（有取捨的 19 組）James 尚未決定，清單在 scratchpad unify_candidates.json（session 結束會消失，要重跑盤查工作流才有）。驗證員擋掉不建議：#21 resA、#10 resB、#20 va、#19 does、#14 impl。注意 #30 P3 現在 vb／result／impl 都有 peace of mind，James 若嫌重複可把 result 退回 feel relaxed and spend more quality time with his family。

> 2026-09-12 **新頁 WE_背誦地圖.html**（James：「把 37 題重新分類，方便背誦」）。做法：執行時 fetch 總表 DATA，先列 44 個跨題共用片語（a steady income 16 題、a warm and stable home 10 題…），題卡裡片語上色、其餘就是該題獨有字，一頁表可按獨有字數排序；默寫模式＋只看獨有字。片語清單在該檔 PHRASES；練習狀態 STATUS 手動維護（1 練過＋老師改過／2 練過／3 沒練過）。曾試過「逐格字組」分法，37 題逐格完全相同只佔 10%，放棄。

> 2026-09-12 **第 3 類（沒練過）13 題逐 slot 走查**（James 要一題一題看，走不完隔天續）。已走：#1（conR → real life shows what schools cannot、concl → say they learned from life experience）、#4（stance → the good effects of design are much greater、does → sits in a bright and well-designed office all day）、#9（補記 0911 首戰訂正；P2 換 James 車禍版＋modal may）、#10（does 縮短）、#19（James 說不用換，reason「in a fair way」保留；備用公平句組：everyone follows the same rules → no one gets an unfair advantage）、#21（0912 第二輪 P2 整段重排：con some positive consequences／conR get news in seconds／cond read the news on their phones every day／resA learn what is happening around the world／resB a broader view of life／concl see the information revolution as a big step forward；final it→the information revolution）。#22（0913：does → keeps away from social media on school days、con us→young people）。**#27（0913：va should be taught／resA see how people lived in the past／does puts all his time into main subjects／result 共用 good job and steady income）。#28（0913：P2 全段換基礎字 part of our history／show how people lived in the past／learn about their own history／many tourists visit；vb go to daily needs first；does a city that spends money on）。#29（0913：p1end why twenty-five is the right age／cond a couple gets married young／reason 縮成 at that age most people have finished school and have a steady income）。#30（0913：vb country life brings more peace of mind／conR are there／reason slow and has far less pressure／does does his job online）。#33（0913：conR everyone wants to earn more／cond people chase higher pay／does 補 because more hours do not mean more pay／rec governments set a fair limit on pay／reason has a limit／impl gives people less overtime and more family time）。#35（0913：resA 縮成 finish their homework faster）。**第 3 類 13 題全部走完（2026-09-13）**。原待處理備註：#29、#30（先看沒問題）、#33（reason「has a top」→ has a limit）、#35。2026-09-13 全 37 篇二次掃描後 James 已決：#14 vb → until they have a steady job；#12 reason → working too much takes away time with family（對齊 James 不加班的例子）；#26 p1end → does more good than harm、impl 去 closer；#3 result learn by himself、cond students need to find resources；#8 modal may；#31 does works full weeks at his firm。James 決定 Report 型五題（#4/#9/#10/#12/#29）的 p1end 全部拿掉、改回模板句 I tend to agree more with the latter（怕背錯，五題統一）；只剩 #26 的 p1end（老師 0903 要求手機題開頭直接表態）。#16 P2 非真讓步（講成因）James 0913 決定不動。#12 reason 定為 it takes away time with family。
